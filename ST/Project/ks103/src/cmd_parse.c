  ...
  else
  {
    switch(c)
    {
      ...
      if(pos)
      {
        ...
        if(strcmp((char *)histBuf[histIns], buffer))
        {
      ...
      case '[': /* Non ASCII characters, arrow. */
        ...
        switch (c)
        {
          case 'A': /* Key: up arrow */
            ...
            upArrowCnt++;
            cmdFlushCopy(pos,buffer,(char *)histBuf[histOutput],histPos[histOutput]);
        ...
        case 'B': /* Key: down arrow */
          ...
          cmdFlushCopy(pos,buffer,(char *)histBuf[histDownArw],histPos[histDownArw]);
